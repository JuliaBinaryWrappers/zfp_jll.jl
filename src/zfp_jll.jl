...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import zfp_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("007be453-5351-5f08-b8c7-bf95923b8de2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "zfp", artifacts_toml) for e in artifacts["zfp"]]
...
if best_platform === nothing
    @debug("Unable to load zfp; unsupported platform $(triplet(platform_key_abi()))")
else
